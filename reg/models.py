...
class Registration(models.Model):
    ...
    classnumber = models.ForeignKey(Class1, models.DO_NOTHING, db_column='classnumber', blank=True, null=True)
    ...
    memberid = models.ForeignKey('Tblmain', models.DO_NOTHING, db_column='memberID', blank=True, null=True)  # Field name made lowercase.
...
class Tblmain(models.Model):
    ...
    medical = models.TextField(db_column='Medical', blank=True, null=True)  # Field name made lowercase.
